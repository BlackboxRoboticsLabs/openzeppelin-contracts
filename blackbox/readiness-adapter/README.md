# Blackbox readiness adapter for OpenZeppelin/openzeppelin-contracts

This fork contains a small Blackbox Robotics compatibility capsule for EVM receipt registry primitives.
